...
var CreativeAssetsMobilePushTemplateView = Backbone.View.extend({
  ...
  renderMobilePush:function(e, tagsPassed){
    ...
    $("#mob_android_container").html(tmpl({ tags: tags, template:  template, tab_value : "android" , template_scope : this.template_scope}));
    $("#mob_ios_container").html(tmpl({ tags: tags, template:  template, tab_value :"ios" , template_scope : this.template_scope}));
    if(!_.isUndefined(template.template_id)){
      ...
      if(!_.isUndefined(template.html_content.IOS) &&
        ...
        this.getSecondaryIOSContainer(e,template);
