...
<div class='ca-mobile-push-container'>
  ...
  <div class="">
    ...
    <input type="hidden" name="ca-mobile-push-id" id="ca-mobile-push-id" value="<%= template.template_id %>">
        ...
        <div id="mobilepush_scope_selector">
          <span style="padding-right: 48px;font-weight: bold;"><?= _campaign("Scope") ?></span>
          <div style="margin-top:2px;"></div>
          <div>
            <form style="display: inline-flex;">
              <label style="padding-right: 21px;">
                <input type="radio" id="mobpush_loyalty" class="mobpush_scope" value="mobilepush_loyalty" <%- (tagScope == 'mobilepush_loyalty')? 'checked': '' %> ><?= _campaign(" LOYALTY") ?>
              </label>
              <label style="padding-right: 21px;">
                <input type="radio" id="mobpush_dvs" class="mobpush_scope" value="mobilepush_dvs" <%- (tagScope == 'mobilepush_dvs')? 'checked': '' %> ><?= _campaign(" DVS") ?>
              </label>
              <label style="padding-right: 21px;">
                <input type="radio" id="mobpush_outbound" class="mobpush_scope" value="mobilepush_outbound" <%- (tagScope == 'mobilepush_outbound')? 'checked': '' %> ><?= _campaign(" OUTBOUND") ?>
              </label>
            </form>
          </div>
        </div>
