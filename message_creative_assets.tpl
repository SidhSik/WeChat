...
<script id="details_tpl" type="text/template">
    ...
    <% } %>
  	...
  	<div class = "c-show-url">
    	...
    	<input type="text" class="c-input-width c-url-data-style c-input-tag-box c-tag-url" name="UrlName" wechat-tag-data="url" placeholder="http://" value="<%=((temp['Url']!='{{wechat_service_acc_url}}')?temp['Url']:'')%>" style="width: 500px;margin: 14px 0 0 52px;" disabled/>
  	</div>
</script>
